...
export default function TokenPage() {
  ...
  return (
    <main id="call-token-page" className="pt-24 pb-12 flex-1">
        <div className="max-w-7xl mx-auto px-6">
            {/* Swap section */}
            <section id="swap-section" className="flex justify-center mt-8 mb-8">
            <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm w-full max-w-lg">
                ...
                <button
                    ...
                    type="button"
                    className={[
                    "cursor-pointer w-full py-4 rounded-xl font-bold text-white hover:shadow-lg transition",
                    isBuyMode
            ...
            {/* Hero */}
            <section id="token-hero" className="text-center mb-12">
            <div className="w-24 h-24 bg-gradient-to-r from-primary to-secondary rounded-full flex items-center justify-center mx-auto mb-6">
                <i className="fas fa-coins text-white text-4xl" />
            </div>
            <h1 className="text-5xl font-bold mb-4 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
                CALL Token
            </h1>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                The governance token powering the Scall.io ecosystem. Participate
                in protocol governance and earn from protocol fees.
            </p>
            </section>
            ...
            >
                ...
                <div className="space-y-2 text-sm">
                    ...
                    <span className="font-semibold">900M CALL</span>
                    </div>
                    <div className="flex justify-between">
                    <span className="text-gray-600">Team Allocation</span>
                    <span className="font-semibold">100M CALL</span>
                    </div>
                </div>
                </div>
            </div>
            ...
            >
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-start">
                        ...
                        <p className="text-gray-600 text-sm">
                            Earn a portion of protocol fees generated from trading
                            and liquidity provision activities.
                        </p>
                        </div>
                    </div>
