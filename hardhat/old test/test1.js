...
describe("Scall", function () {
  ...
  describe("LPs :: Check", function () {
    ...
    it("Should claim fees for owner call", async function () {
      ...
      let tx = await collateralPool.read.getRewardsForLp([0n, 0n]);
  ...
  describe("MAIN :: Edit Market infos", function () {
    ...
    it("Should edit market infos", async function () {
      ...
      await main.write.updateMarket([marketPool.address, fakeBtcOracle.address, 8n, 8n, 500n * 10n ** 18n, 3600], { account: owner.account });
  ...
  describe("LPs :: Check", function () {
    ...
    it("Should deposit put LP at correct interval for Owner", async function () {
      // READ intervals
      let intervals = await marketPool.read.getIntervals([]);
      console.log("Intervals:", intervals);
  ...
  describe("LPs :: Check", function () {
    ...
    it("Should give market's owner put LP infos", async function () {
      let tx = await marketPool.read.getLpInfos(
        [1n]
      );
      console.log(tx);
    ...
    it("Should claim fees for owner call", async function () {
      ...
      let tx = await collateralPool.read.getRewardsForLp([0n, 1n]);
      console.log("rewards for owner call :", Number(tx / 10n ** 18n));
